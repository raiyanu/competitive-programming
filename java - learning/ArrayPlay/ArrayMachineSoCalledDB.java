...
public class ArrayMachineSoCalledDB {
	static void printTasks(ArrayList<ArrayList<String>> TodoDB){
		...
		for (int i = 0; i < TodoDB.size(); i++){ 
			System.out.println(i + ". " + TodoDB.get(i).get(0) + " : " + TodoDB.get(i).get(1)
          + " : " + TodoDB.get(i).get(2));
		}
		System.out.println("---------------------------------------------\n\n");
		...
		while (task != "end") {
			...
			if (taskSelection == 1) {
				...
				if (editTaskSelection > TodoDB.size() - 1) {
					...
					System.out.println(editTaskSelection+ ". " + TodoDB.get(editTaskSelection).get(0) + " : " + TodoDB.get(editTaskSelection).get(1) + " : " + TodoDB.get(editTaskSelection).get(2));
				}
				...
				if ( emptyAllSelection.equals("Yes") || emptyAllSelection.equals("yes")|| emptyAllSelection.equals("Y") || emptyAllSelection.equals("y")){
					TodoDB.clear();
